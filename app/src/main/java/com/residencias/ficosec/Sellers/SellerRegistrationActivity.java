...
import com.residencias.ficosec.Buyers.LoginActivity;
...
public class SellerRegistrationActivity extends AppCompatActivity {
    ...
    private void registerSeller() {
        ...
        if (!name.equals("") && !phone.equals("") && !email.equals("") && !password.equals("") && !address.equals("")){
                        ...
                        rootRef.child("Sellers").child(sid).updateChildren(sellerMap)
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        loadingBar.dismiss();
                                        Toast.makeText(SellerRegistrationActivity.this, "Te has registrado como vendedor correctamente", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(this, "Porfavor completa los campos de registro", Toast.LENGTH_SHORT).show();
        }
